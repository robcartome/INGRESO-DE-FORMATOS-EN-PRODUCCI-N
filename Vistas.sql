...
SELECT * FROM public.verificaciones_areas_produccion_insectos_roedores

SELECT * FROM 
public.areas_produccion

SELECT * FROM v_registros_monitores_insectos_roedores WHERE estado = 'CERRADO'
